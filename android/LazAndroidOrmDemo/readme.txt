...
2. If Android Virtual Device[AVD]/Emulator [or real device] is running then:
   ...
   2.2 look for the App "LazAndroidOrmDemo" in the Emulator [or real device] and click it!
...
3. If AVD/Emulator is NOT running:
   ...
   3.3 look for the App "LazAndroidOrmDemo" in the Emulator and click it!
...
6. To find your Apk look for the "LazAndroidOrmDemo-debug.apk" in \bin folder!
 
7. Android Asset Packaging Tool: to know which files were packed in "LazAndroidOrmDemo-debug.apk"
