...
Is <CN=MyFirstName MyLastName, OU=MyDevelopmentUnit, O=MyExampleCompany,
  ...
  [no]:  y
Enter key password for <lazandroidormdemoaliaskey> <RETURN if same as keystore password>: 123456

3. Execute "release-keystore.bat" [.sh]
            warning: well, before execute, you can change/edit the [param] -alias lazandroidormdemoaliaskey
              ex.  -alias www.mycompany.com 
              Please, change/edit/Sync [key.alias=lazandroidormdemoaliaskey] "ant.properties" too!

4. Edit [notepad like] "ant.properties" to more representative information!"
        warning: "key.alias=lazandroidormdemoaliaskey" need be the same as in "release-keystore.bat [.sh]"
